...
begin
	using IndividualDisplacements, PlutoUI, CairoMakie
...
begin
	...
	u,v,w=IndividualDisplacements.vortex_flow_field(np=np,nz=nz) #staggered velocity arrays
...
f=plot( InDiPlot( data=(I=I,), options=(plot_type=:simple_plot2,) ) )
...
manifest_format = "2.0"
project_hash = "8824a1ade96f8cd7bd51e1f1614d511be700800b"
